...
namespace KPLNET.Metrics
{
	...
	public struct Names
	{
		...
		public const string UserRecordsReceived = "UserRecordsReceived";
		public const string UserRecordsPending = "UserRecordsPending";
		public const string UserRecordsPut = "UserRecordsPut";
		public const string UserRecordsDataPut = "UserRecordsDataPut";

		public const string KinesisRecordsPut = "KinesisRecordsPut";
		public const string KinesisRecordsDataPut = "KinesisRecordsDataPut";

		public const string ErrorsByCode = "ErrorsByCode";
		public const string AllErrors = "AllErrors";
		public const string RetriesPerRecord = "RetriesPerRecord";
		public const string UserRecordExpired = "UserRecordExpired";

		public const string BufferingTime = "BufferingTime";
		public const string RequestTime = "RequestTime";

		public const string UserRecordsPerKinesisRecord = "UserRecordsPerKinesisRecord";
		public const string KinesisRecordsPerPutRecordsRequest = "KinesisRecordsPerPutRecordsRequest";
		public const string UserRecordsPerPutRecordsRequest = "UserRecordsPerPutRecordsRequest";
	}
	public struct Units
	{
	...
	public class MetricsManager
	{
		...
		#region SDKClientImplementation
